      ...
      <form v-if="docente">
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <button type="submit" @click="registroDocente()" class="btn btn-primary mb-3 float-end">
                Registrarme
              </button>
            </div>
          </div>
      ...
      <form v-if="administrativo">
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <button type="submit" @click="registroAdministrativo()" class="btn btn-primary mb-3 float-end">
                Registrarme
              </button>
            </div>
          </div>
